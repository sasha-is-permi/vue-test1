...
[
  {
    ...
    "data": {
      ...
      "general": {
        ...
        "externalInfo": [
          {
            "url": "https://www.culture.ru/institutes/40840/biblioteka-14-s-kemul",
    ...
    "errorFields": [
      {
        ...
        "schemaPath": "#/properties/general/properties/address/properties/mapPosition/properties/coordinates/items/type",
        "params": {
          "type": "array"
        },
    ...
    "odSetVersions": [
      ...
      "60120c0a7892291ba0ba89c1",
      "601a9edb970c0c3b3676505b",
      "6042ccbb3018a17df18c15b4",
      "606ba57721aa3871deee6c6d",
      "6093328921aa3871deee715b",
      "609333a221aa3871deee7164",
      "60bac0a721aa3871deee7664",
      "60e24dab21aa3871deee7b4d",
      "6109dab321aa3871deee8100"
    ],
    ...
    "modified": "2021-08-04T00:15:07.345Z"
  }
]
-->
...
<template>
  <div id="app">
     ...
     <div id="pictures">
       <img  v-show="visible1" class="picture"  src="@/assets/library1.jpg"/> 
        <img v-show="visible1" class="picture" src="@/assets/library2.jpg"/>
        <img v-show="visible1" class="picture"  src="@/assets/library3.jpg"/>
     </div>  
    <div id="nav">
      <router-link v-show="visible1"   to="/List">
        <span @click="hidePictures">Загрузить список библиотек</span>      
      </router-link> 
    </div>
    <router-view/>
  </div>
